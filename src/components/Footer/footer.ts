...
export default class Footer {
    createFooter(): HTMLElement {
        ...
        const githubText2 = createHtmlElement('span', 'github__text', 'artemkamyshenkov', githubLink2);
        ...
        const githubImg3 = createHtmlElement('div', 'github__img', '', githubLink3);
        const githubText3 = createHtmlElement('span', 'github__text', 'Gregory-Vinokur', githubLink3);
